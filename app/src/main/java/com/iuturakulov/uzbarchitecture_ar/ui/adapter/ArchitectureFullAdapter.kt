...
import com.iuturakulov.uzbarchitecture_ar.databinding.ArchFullItemBinding
...
class ArchitectureFullAdapter : RecyclerView.Adapter<ArchitectureFullAdapter.ArchViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArchViewHolder {
        ...
        val binding =
            DataBindingUtil.inflate<ArchFullItemBinding>(
                inflater,
                R.layout.arch_full_item,
                parent,
                false
            )
    ...
    class ArchViewHolder(val binding: ArchFullItemBinding) :
